...
export default function CertificatePage() {
  ...
  usePdfExport(exportPdfRef, certRef, cert.title.replace(/\s+/g, '-'), cert.title);
            ...
            >
              ...
              <div className="px-12 pt-10 pb-8">
                ...
                <div className="text-center mb-10">
                  ...
                  >
                    <span style={{ color: '#ffffff', fontSize: '1.5rem', lineHeight: 1, display: 'inline-block' }}>{cert.emoji}</span>
                    <h2 style={{ color: '#ffffff', fontSize: '1.25rem', fontWeight: 900, letterSpacing: '-0.025em', margin: 0, padding: 0, fontFamily: 'Arial, sans-serif' }}>{cert.title}</h2>
                  </div>
                ...
                <div className="flex items-end justify-between border-t border-slate-200 pt-7">
                  ...
                  <div className="text-center">
                    <div
                      className={`w-16 h-16 rounded-full bg-gradient-to-br ${cert.gradient} flex items-center justify-center mx-auto mb-2 shadow-md`}
          ...
          <div className="w-full lg:w-72 flex-shrink-0 space-y-4 print:hidden">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
              ...
              <p className="text-sm text-slate-500 font-mono leading-relaxed">
                You've earned the <span className="text-cyan-600 font-semibold">{cert.title}</span> certification. Your credential is now live.
              </p>
            </div>
              ...
              <button
                onClick={() => {
                  if (navigator.share) {
                    navigator.share({
                      title: cert.title,
                      text: `I just earned the ${cert.title} certification from Learnflow!`,
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
              ...
              <div className="space-y-2">
                {CERTS.filter(c => c.id !== cert.id).slice(0, 3).map(c => (
                  <button
                    key={c.id}
