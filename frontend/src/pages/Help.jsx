...
const CATS = [
 { id:'courses', icon:BookOpen, label:'Courses & Learning', color:'bg-cyan-50 border-cyan-200 text-cyan-600', count:12 },
 { id:'billing', icon:CreditCard, label:'Billing & Payments', color:'bg-emerald-50 border-emerald-200 text-emerald-600', count:8 },
 { id:'certs', icon:Award, label:'Certifications', color:'bg-violet-50 border-violet-200 text-violet-600', count:6 },
 { id:'live', icon:Wifi, label:'Live Sessions', color:'bg-amber-50 border-amber-200 text-amber-600', count:7 },
 { id:'account', icon:User, label:'Account & Profile', color:'bg-rose-50 border-rose-200 text-rose-600', count:9 },
 { id:'technical', icon:Settings, label:'Technical Support', color:'bg-slate-50 border-slate-200 text-slate-600', count:5 },
];

const FAQS = [
 { cat:'courses', q:'How do I enrol in a course?', a:'Browse courses, click "Enrol Now", and pay via UPI, net banking, card, or EMI. You get immediate access once payment is confirmed.' },
 ...
 { cat:'certs', q:'How do I earn my certificate?', a:'Complete all modules (80% video progress), submit assignments, and pass the final assessment with 70% or above. Certificate issued within 24 hours.' },
...
export default function Help() {
 ...
 <p className="text-slate-600 text-xl leading-relaxed max-w-xl mx-auto mb-10">Browse FAQs or search for your question. Our India-based support team is always one message away.</p>
