...
const FAQS = [
 ...
 { cat:'courses', q:'Can I switch to a different batch?', a:'Yes, you can request a batch transfer within the first 7 days of enrolment. Email support@Learnodays.in or WhatsApp us.' },
 { cat:'courses', q:'Can I download course videos for offline viewing?', a:'Yes, the Learnodays mobile app lets you download videos for offline viewing. Downloads are available for 30 days before they need to be refreshed.' },
 ...
 { cat:'billing', q:'My payment failed but money was deducted. What do I do?', a:'Failed payment refunds are automatically processed within 5–7 business days by your bank. If not received after 7 days, email billing@Learnodays.in with your transaction ID.' },
 ...
 { cat:'billing', q:'Do you offer student or group discounts?', a:'Yes! Students get 20% off with a valid college ID. Groups of 5 or more get 30% off. Email sales@Learnodays.in for group pricing.' },
 ...
 { cat:'certs', q:'How do employers verify my certificate?', a:'Each certificate has a unique QR code. Employers scan it or visit Learnodays.in/verify and enter the 16-character credential ID.' },
 { cat:'certs', q:'Can I add it to LinkedIn?', a:'Yes! Click "Add to LinkedIn" on your certificate page — it adds automatically to Licences & Certifications. Learnodays is a recognised LinkedIn issuer.' },
 { cat:'certs', q:'Do certificates expire?', a:'Learnodays certificates do not expire. Tech-specific certs note a "knowledge as of [year]" date to help employers contextualise the content.' },
 ...
 { cat:'certs', q:'Is the certificate recognised by companies?', a:'Learnodays certificates are recognised by 500+ hiring partners including TCS, Infosys, Wipro, and several MNCs. The full list is available on our Hiring Partners page.' },
 { cat:'certs', q:'What if my name is incorrect on my certificate?', a:'Update your legal name in Settings → Account → Full Name before completing the course. If already issued, email support@Learnodays.in with your ID proof for a reissue.' },
 ...
 { cat:'account', q:'How do I reset my password?', a:'Go to Learnodays.in/login → "Forgot Password". Enter your email or phone — you\'ll receive a reset link within 2 minutes.' },
 ...
 { cat:'technical', q:'Videos won\'t play. What do I do?', a:'Try Chrome or Firefox. Clear cache/cookies. Check your internet speed (min 5 Mbps). If the issue persists, contact support@Learnodays.in.' },
 { cat:'technical', q:'I can\'t log in. What should I do?', a:'Reset your password via the "Forgot Password" link. If you still can\'t log in, email support@Learnodays.in with your registered email.' },
 ...
 { cat:'technical', q:'My certificate is not generating. What should I do?', a:'Ensure you have met all completion requirements: 80% video progress, all assignments submitted, and assessment passed. If requirements are met, contact support@Learnodays.in.' },
 ...
 { cat:'technical', q:'How do I report a bug or technical issue?', a:'Use the "Report an Issue" button in the app or email support@Learnodays.in with a screenshot and description. Our tech team responds within 24 hours.' },
];
