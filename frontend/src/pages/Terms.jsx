...
const SECTIONS = [
 { id:'acceptance', title:'1. Acceptance of Terms', body:`These Terms of Service ("Terms") constitute a legally binding agreement between you ("User") and Learnodays Technologies Private Limited (CIN U72900KA2020PTC135792), a company incorporated under the Companies Act, 2013, with its registered office at Learnodays Tower, Phase II, Ghodbunder Rd, near Viviana Mall, Thane West, Maharashtra — 400 606\n\nBy creating an account, enrolling in a course, or otherwise using the Platform, you agree to be bound by these Terms, our Privacy Policy, and our Cookie Policy.\n\nThese Terms are governed by the laws of India, including the Information Technology Act, 2000, the Consumer Protection Act, 2019, and all applicable rules thereunder.` },
 ...
 { id:'ip', title:'7. Intellectual Property', body:`All content on the Platform — including course videos, slides, assessments, code samples, trademarks, and logos — is owned by or licensed to Learnodays Technologies Private Limited and is protected under the Copyright Act, 1957 and the Trade Marks Act, 1999.\n\nInstructors retain ownership of their original content but grant Learnodays a worldwide, royalty-free licence to host, distribute, and sublicense that content to enrolled learners.` },
 { id:'liability', title:'8. Disclaimers & Limitation of Liability', body:`No Employment Guarantee: Learnodays provides education and career support but does not guarantee employment or salary increases.\n\nPlatform Availability: We strive for 99.9% uptime but do not guarantee uninterrupted access. Scheduled maintenance is announced 48 hours in advance.\n\nLimitation: To the maximum extent permitted by Indian law, Learnodays's total liability for any claim shall not exceed the amount paid by you for the specific course in the 3 months preceding the claim. Learnodays shall not be liable for indirect or consequential damages.` },
 { id:'governing', title:'9. Governing Law & Disputes', body:`These Terms are governed by the laws of India.\n\nInformal Resolution: Contact us first at legal@Learnodays.in. Most disputes resolve amicably within 30 days.\n\nArbitration: Unresolved disputes shall be referred to arbitration under the Arbitration and Conciliation Act, 1996. Seat: Thane, Maharashtra. Language: English.\n\nConsumer Disputes: Nothing in these Terms limits your rights under the Consumer Protection Act, 2019, including the right to approach the District Consumer Disputes Redressal Commission for Thane.\n\nCourts: For non-arbitrable matters, the courts of Thane, Maharashtra shall have exclusive jurisdiction.` },
 { id:'amendments', title:'10. Amendments', body:`Learnodays may modify these Terms at any time. Material changes will be communicated via email and platform notice at least 15 days before they take effect. Continued use after the effective date constitutes acceptance.` },
];
...
export default function Terms() {
 ...
 <p className="text-sm text-slate-500 font-mono">Learnodays Technologies Pvt Ltd · CIN U72900KA2020PTC135792 · Last updated: 15 January 2025</p>
 ...
 <p className="text-sm text-slate-600 font-sans mb-4">Legal queries? Email legal@Learnodays.in. For general support, visit our Help Centre.</p>
