...
const TIMELINE = [
 ...
 { year:'2024', title:'AI Learning Engine', desc:'Launched personalised AI learning paths, real-time doubt resolution, and automated progress analytics — making Learnflow the most intelligent learning platform built in India.' },
 { year:'2025', title:'50,000 Learners & Beyond', desc:'Today, Learnflow serves 50,000+ learners across 3 states. On a mission to place 1 million Indians in quality tech careers by 2030.' },
];
...
export default function About() {
 ...
 <p>Learnflow bridges this gap with practical, project-based learning taught by people who are actually doing the work — not retired professors reading from slides.</p>
 ...
 <h2 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight">The people building Learnflow</h2>
 </div>
