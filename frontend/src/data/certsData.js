export const CERTS = [
  {
    ...
    lessons: [
      ...
      { id: '1-4', weekLabel: 'Week 3–5', title: 'React Router & State Management', duration: '50 min', videoId: 'AK2fmY-aAfo', description: 'Master client-side routing with React Router and global state management patterns using Context API and Redux.' },
